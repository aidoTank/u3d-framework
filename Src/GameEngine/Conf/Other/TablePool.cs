...
namespace GameEngine
{
    ...
    /// 表数据池-对外接口
    /// </summary>
    public partial class TablePool : Singleton<TablePool>
    {
        // 配置表池
        private static Dictionary<Type, Dictionary<string, BaseTbl>> m_tblPool;
        ...
        private void InitCfg<TblClass, CfgClass>() where CfgClass : BaseCfg, new()
        {
